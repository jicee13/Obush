...
fileName <- "/Users/jmiller/Desktop/opm-federal-employment-data/data/1973-09-to-2014-06/dod/status/Status_DoD_1973_09.txt"
...
dat_header <- read.csv("/Users/jmiller/Downloads/headers (3).csv", header = TRUE)
# dat_header
